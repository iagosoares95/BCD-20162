...
DELIMITER $$
CREATE PROCEDURE get_disciplina_horario(beg time,fin time) # valor 7:30/13:30 a 11:30/17:30
BEGIN
SELECT horario.disciplina
  FROM horario
  inner join disciplina
...
CALL get_disciplina_horario('7:30','8:25');
CALL get_disciplina_horario('8:25','9:20');
CALL get_disciplina_horario('9:40','10:35');
CALL get_disciplina_horario('10:35','11:30');
